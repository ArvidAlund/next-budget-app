    ...
    return (
        <div className="p-4 grid gap-2 grid-cols-2 items-center">  
            <div className="sm:w-3/4">
                <h2 className="text-xl font-semibold mb-2">Exportera Transaktioner</h2>
                <p>Exportera dina transaktioner i olika format för säkerhetskopiering eller överföring.</p>
            </div>
