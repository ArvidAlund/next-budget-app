        ...
        {loaded ? (
          <>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-green-900/10 border border-green-500/50 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow duration-300 h-full w-full text-xs lg:text-lg lg:shadow-lg">
              ...
              <div className="bg-red-900/10 border border-red-500/50 rounded-lg p-4 text-xs lg:text-lg lg:shadow-lg hover:shadow-md transition-shadow duration-300 h-full w-full">
                <div className="flex items-center gap-2">
